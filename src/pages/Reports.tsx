                    ...
                    <tbody className="divide-y divide-white/[0.04]">{filteredVouchers.length > 0 ? [...filteredVouchers].sort((a, b) => {
                        ...
                        return (
                            <tr key={v.code} className="hover:bg-white/[0.03] transition-colors group">
                                <td className="px-4 py-3"><span className="font-mono font-black text-xs text-amber-400 bg-amber-500/10 px-2 py-0.5 rounded-lg border border-amber-500/20">{v.code}</span></td>
